...
public class Routes {
    ...
    public static Route submit = (request, response) -> {
        ...
        int account_id = NumberUtils.toInt(String.valueOf(bodyJsonMap.get("account_id")), 0);
...
//        StatUtil.getTaskStat()
     ...
     * 获取当前系统中有多少个设备在运行
     */
    public static Route getDevicesInfo = (request, response) -> new Msg<>(AndroidDeviceManager.getInstance().deviceTaskMap.keySet());
}
